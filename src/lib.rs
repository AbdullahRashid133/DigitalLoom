...
#[derive(Debug)]
pub struct DigitalLoomProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DigitalLoomProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DigitalLoom processing");
    
    let mut processor = DigitalLoomProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DigitalLoomProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DigitalLoomProcessor::new(false);
